...
export function renderAppShell() {
  ...
  const iconGestaAgenda = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h18"/><path d="m15.2 16.9-.9-.3"/><circle cx="18" cy="18" r="3"/></svg>`;
