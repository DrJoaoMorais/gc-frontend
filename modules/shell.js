...
export function renderAppShell() {
  ...
  const iconLogout = `<svg width="18" height="18" viewBox="0 0 20 20" fill="none"><path d="M13 14l4-4-4-4M17 10H7" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 17H5a2 2 0 01-2-2V5a2 2 0 012-2h5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>`;
