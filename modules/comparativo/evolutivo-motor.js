...
const PARAM_MAP = {
  ...
  lombar: [
    ...
    { chave: 'eva.act', grupo: 'Dor (EVA)', label: 'Actividade', unidade: '/10', dirBom: 'desce', tipo: 'num' },
    { chave: 'eva.pic', grupo: 'Dor (EVA)', label: 'Pico', unidade: '/10', dirBom: 'desce', tipo: 'num' },
    { chaveA: 'rom.lomb_flex_a', chaveP: 'rom.lomb_flex_p', grupo: 'Mobilidade (ROM)', label: 'Flexão anterior', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.lomb_ext_a', chaveP: 'rom.lomb_ext_p', grupo: 'Mobilidade (ROM)', label: 'Extensão', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.lomb_inc_d_a', chaveP: 'rom.lomb_inc_d_p', grupo: 'Mobilidade (ROM)', label: 'Inclinação lateral D', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.lomb_inc_e_a', chaveP: 'rom.lomb_inc_e_p', grupo: 'Mobilidade (ROM)', label: 'Inclinação lateral E', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.lomb_rot_d_a', chaveP: 'rom.lomb_rot_d_p', grupo: 'Mobilidade (ROM)', label: 'Rotação D', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.lomb_rot_e_a', chaveP: 'rom.lomb_rot_e_p', grupo: 'Mobilidade (ROM)', label: 'Rotação E', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chave: 'mrc.f_flex_anca', grupo: 'Força MRC', label: 'Flexão anca (L2)', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_ext_joe', grupo: 'Força MRC', label: 'Extensão joelho (L3)', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_dors_torn', grupo: 'Força MRC', label: 'Dorsiflexão tornozelo (L4)', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_ext_halux', grupo: 'Força MRC', label: 'Extensão hálux (L5)', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_flex_plant', grupo: 'Força MRC', label: 'Flexão plantar (S1)', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'escalas.odi_score', grupo: 'Escalas Funcionais', label: 'ODI', unidade: '%', dirBom: 'desce', tipo: 'num' },
    { chave: 'testes.t_lasegue', grupo: 'Testes Clínicos', label: 'Lasègue', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_lasegue_c', grupo: 'Testes Clínicos', label: 'Lasègue cruzado', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_slump', grupo: 'Testes Clínicos', label: 'Slump', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_bragard', grupo: 'Testes Clínicos', label: 'Bragard', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_faber', grupo: 'Testes Clínicos', label: 'FABER', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_gaenslen', grupo: 'Testes Clínicos', label: 'Gaenslen', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_thigh', grupo: 'Testes Clínicos', label: 'Thigh thrust', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_comp_si', grupo: 'Testes Clínicos', label: 'Compression test SI', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_distr_si', grupo: 'Testes Clínicos', label: 'Distraction test SI', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_dor_ext', grupo: 'Testes Clínicos', label: 'Dor à extensão', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_dor_rot', grupo: 'Testes Clínicos', label: 'Dor à rotação', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_kemp', grupo: 'Testes Clínicos', label: 'Kemp', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_claud_neu', grupo: 'Testes Clínicos', label: 'Claudicação neurogénica', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_aliv_flex', grupo: 'Testes Clínicos', label: 'Alívio em flexão', unidade: '', dirBom: 'desce', tipo: 'teste' },
    ...
    { chave: 'func.func_agac', grupo: 'Funcional', label: 'Agachar-se', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_calc', grupo: 'Funcional', label: 'Calçar meias/sapatos', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_sent', grupo: 'Funcional', label: 'Ficar sentado prolongado', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_pe', grupo: 'Funcional', label: 'Estar de pé prolongado', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_dorm', grupo: 'Funcional', label: 'Dormir', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_cond', grupo: 'Funcional', label: 'Conduzir', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_prof', grupo: 'Funcional', label: 'Actividade profissional', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_desp', grupo: 'Funcional', label: 'Actividade desportiva', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_pegar', grupo: 'Funcional', label: 'Pegar objectos do chão', unidade: '', dirBom: null, tipo: 'func' },
  ],
  joelho: [
    { chave: 'eva.rep', grupo: 'Dor (EVA)', label: 'Repouso', unidade: '/10', dirBom: 'desce', tipo: 'num' },
    { chave: 'eva.act', grupo: 'Dor (EVA)', label: 'Actividade', unidade: '/10', dirBom: 'desce', tipo: 'num' },
    ...
    { chaveA: 'rom.flex_a', chaveP: 'rom.flex_p', grupo: 'Mobilidade (ROM)', label: 'Flexão', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.ext_a', chaveP: 'rom.ext_p', grupo: 'Mobilidade (ROM)', label: 'Extensão', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chave: 'mrc.f_quad', grupo: 'Força MRC', label: 'Quadricípite', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_isq', grupo: 'Força MRC', label: 'Isquiotibiais', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_glmed', grupo: 'Força MRC', label: 'Glúteo médio', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_gem', grupo: 'Força MRC', label: 'Gémeos', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'dyn.flex.d', grupo: 'Dinamometria', label: 'Flexão D', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.flex.e', grupo: 'Dinamometria', label: 'Flexão E', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.ext.d', grupo: 'Dinamometria', label: 'Extensão D', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.ext.e', grupo: 'Dinamometria', label: 'Extensão E', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_sint_score', grupo: 'Escalas Funcionais', label: 'KOOS Sintomas', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_dor_score', grupo: 'Escalas Funcionais', label: 'KOOS Dor', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_avd_score', grupo: 'Escalas Funcionais', label: 'KOOS AVD', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_desp_score', grupo: 'Escalas Funcionais', label: 'KOOS Desporto', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_qdv_score', grupo: 'Escalas Funcionais', label: 'KOOS QdV', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'testes.t_lachman', grupo: 'Testes Clínicos', label: 'Lachman', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_vv0', grupo: 'Testes Clínicos', label: 'Varo/Valgo 0°', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_vv30', grupo: 'Testes Clínicos', label: 'Varo/Valgo 30°', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_pivot', grupo: 'Testes Clínicos', label: 'Pivot shift', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_gavant', grupo: 'Testes Clínicos', label: 'Gaveta anterior', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_gavpost', grupo: 'Testes Clínicos', label: 'Gaveta posterior', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_rottib', grupo: 'Testes Clínicos', label: 'Rotação tibial', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_dorint', grupo: 'Testes Clínicos', label: 'Dor na interlinha', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_mcmurray', grupo: 'Testes Clínicos', label: 'McMurray', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_thessaly', grupo: 'Testes Clínicos', label: 'Thessaly', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_bloqueio', grupo: 'Testes Clínicos', label: 'Bloqueio / catching', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_apprehension', grupo: 'Testes Clínicos', label: 'Apprehension patelar', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_tracking', grupo: 'Testes Clínicos', label: 'Tracking patelar', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_jsign', grupo: 'Testes Clínicos', label: 'J-sign', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_compressao', grupo: 'Testes Clínicos', label: 'Compressão patelar', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_tilt', grupo: 'Testes Clínicos', label: 'Tilt patelar', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_clarke', grupo: 'Testes Clínicos', label: 'Clarke', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'func.func_plan', grupo: 'Funcional', label: 'Caminhar em plano', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_esc', grupo: 'Funcional', label: 'Escadas e rampas', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_lev', grupo: 'Funcional', label: 'Levantar do chão/cadeira', unidade: '', dirBom: null, tipo: 'func' },
    ...
    { chave: 'func.func_prof', grupo: 'Funcional', label: 'Actividade profissional', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_desp', grupo: 'Funcional', label: 'Actividade desportiva', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_inst', grupo: 'Funcional', label: 'Instabilidade / falseios', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_bloq', grupo: 'Funcional', label: 'Bloqueio / derrame recorrente', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_agac', grupo: 'Funcional', label: 'Agachar', unidade: '', dirBom: null, tipo: 'func' },
  ],
  anca: [
    { chave: 'eva.rep', grupo: 'Dor (EVA)', label: 'Repouso', unidade: '/10', dirBom: 'desce', tipo: 'num' },
    { chave: 'eva.act', grupo: 'Dor (EVA)', label: 'Actividade', unidade: '/10', dirBom: 'desce', tipo: 'num' },
    ...
    { chaveA: 'rom.ext_a', chaveP: 'rom.ext_p', grupo: 'Mobilidade (ROM)', label: 'Extensão', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.abd_a', chaveP: 'rom.abd_p', grupo: 'Mobilidade (ROM)', label: 'Abdução', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.adu_a', chaveP: 'rom.adu_p', grupo: 'Mobilidade (ROM)', label: 'Adução', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.ri_a', chaveP: 'rom.ri_p', grupo: 'Mobilidade (ROM)', label: 'Rotação Interna', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chaveA: 'rom.re_a', chaveP: 'rom.re_p', grupo: 'Mobilidade (ROM)', label: 'Rotação Externa', unidade: '°', dirBom: 'sobe', tipo: 'rom_ap' },
    { chave: 'mrc.f_flex', grupo: 'Força MRC', label: 'Flexão', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_ext', grupo: 'Força MRC', label: 'Extensão', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_abd', grupo: 'Força MRC', label: 'Abdução', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_adu', grupo: 'Força MRC', label: 'Adução', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_ri', grupo: 'Força MRC', label: 'Rotação Interna', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'mrc.f_re', grupo: 'Força MRC', label: 'Rotação Externa', unidade: '', dirBom: 'sobe', tipo: 'mrc' },
    { chave: 'dyn.flex.d', grupo: 'Dinamometria', label: 'Flexão D', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.flex.e', grupo: 'Dinamometria', label: 'Flexão E', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.ext.d', grupo: 'Dinamometria', label: 'Extensão D', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.ext.e', grupo: 'Dinamometria', label: 'Extensão E', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.abd.d', grupo: 'Dinamometria', label: 'Abdução D', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.abd.e', grupo: 'Dinamometria', label: 'Abdução E', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.adu.d', grupo: 'Dinamometria', label: 'Adução D', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.adu.e', grupo: 'Dinamometria', label: 'Adução E', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.ri.d', grupo: 'Dinamometria', label: 'Rot. Interna D', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.ri.e', grupo: 'Dinamometria', label: 'Rot. Interna E', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.re.d', grupo: 'Dinamometria', label: 'Rot. Externa D', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'dyn.re.e', grupo: 'Dinamometria', label: 'Rot. Externa E', unidade: ' kg', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_dor_score', grupo: 'Escalas Funcionais', label: 'HOOS Dor', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_sint_score', grupo: 'Escalas Funcionais', label: 'HOOS Sintomas', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_avd_score', grupo: 'Escalas Funcionais', label: 'HOOS AVD', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_desp_score', grupo: 'Escalas Funcionais', label: 'HOOS Desporto', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'escalas.hoos_qdv_score', grupo: 'Escalas Funcionais', label: 'HOOS QdV', unidade: '/100', dirBom: 'sobe', tipo: 'num' },
    { chave: 'testes.t_fadir', grupo: 'Testes Clínicos', label: 'FADIR', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_faber', grupo: 'Testes Clínicos', label: 'FABER — Patrick', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_scour', grupo: 'Testes Clínicos', label: 'Scour test', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_logroll', grupo: 'Testes Clínicos', label: 'Log roll', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_stinch', grupo: 'Testes Clínicos', label: 'Stinchfield', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_slst', grupo: 'Testes Clínicos', label: 'Single-leg stance', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_resabd', grupo: 'Testes Clínicos', label: 'Resisted abduction', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_ptro', grupo: 'Testes Clínicos', label: 'Palpação trocânter maior', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_thomas', grupo: 'Testes Clínicos', label: 'Thomas', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_reslsr', grupo: 'Testes Clínicos', label: 'Resisted SLR', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_snap', grupo: 'Testes Clínicos', label: 'Snapping / ressalto', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_sq0', grupo: 'Testes Clínicos', label: 'Squeeze 0°', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_sq45', grupo: 'Testes Clínicos', label: 'Squeeze 45°', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_sq90', grupo: 'Testes Clínicos', label: 'Squeeze 90°', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_psinf', grupo: 'Testes Clínicos', label: 'Palpação sínfise púbica', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_ober', grupo: 'Testes Clínicos', label: 'Ober', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_laseg', grupo: 'Testes Clínicos', label: 'Lasègue', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_slump', grupo: 'Testes Clínicos', label: 'Slump', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'testes.t_si', grupo: 'Testes Clínicos', label: 'Sacroilíaca (Gaenslen/FABER-SI)', unidade: '', dirBom: 'desce', tipo: 'teste' },
    { chave: 'func.func_plan', grupo: 'Funcional', label: 'Caminhar em plano', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_esc', grupo: 'Funcional', label: 'Escadas e rampas', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_lev', grupo: 'Funcional', label: 'Levantar do chão/cadeira', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_dorm', grupo: 'Funcional', label: 'Dormir sobre lado afectado', unidade: '', dirBom: null, tipo: 'func' },
    ...
    { chave: 'func.func_prof', grupo: 'Funcional', label: 'Actividade profissional', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_desp', grupo: 'Funcional', label: 'Actividade desportiva', unidade: '', dirBom: null, tipo: 'func' },
    { chave: 'func.func_snap', grupo: 'Funcional', label: 'Ressalto / clique na anca', unidade: '', dirBom: null, tipo: 'func' },
  ],
  cotovelo: [
    { chave: 'eva.rep', grupo: 'Dor (EVA)', label: 'Repouso', unidade: '/10', dirBom: 'desce', tipo: 'num' },
    { chave: 'eva.act', grupo: 'Dor (EVA)', label: 'Actividade', unidade: '/10', dirBom: 'desce', tipo: 'num' },
...
export function labelRegiao(tipo, lado) {
  const nomes = {
    teleconsulta: 'Avaliação Funcional',
